...
(custom-set-variables
 ...
 '(package-selected-packages
   '(exec-path-from-shell web-mode json-mode js2-mode tide typescript-mode kaolin-themes darkmine-theme flycheck nyan-mode which-key rainbow-delimiters moe-theme rust-mode melancholy-theme monokai-theme corfu affe use-package fireplace vertico circe-notifications magit vterm helpful evil doom-modeline company circe evil-magit bind-key)))
